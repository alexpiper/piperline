...
Note: This is pretty slow - in future consider conducting UMI consensus on F and R seperately then merge?
```{r}
...
# Filter UMIs and create consensus
...
BrowseSeqs(AlignSeqs(DNAStringSet(umi_consensus$consensus[526:762])))
